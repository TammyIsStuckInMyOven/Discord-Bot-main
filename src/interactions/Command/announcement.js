    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addStringOption(option => option.setName('servername').setDescription('Your announcement message').setRequired(true))
                .addStringOption(option => option.setName('profilelink').setDescription('Your announcement message').setRequired(true))
                .addStringOption(option => option.setName('enemiesnallies').setDescription('Your announcement message').setRequired(true))
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('edit')
